"""
    Package for testing python external client sender.
"""

import unittest
import mock
from messaging_components.clients.external.python import Sender


class PythonExternalSender(unittest.TestCase):
    ...
    def test_command_prefix(self):
        ...
        :rtype:
        """
        prefix = 'cli-proton-python-sender'
    ...
    def test_minimal_message_command_build(self):
        ...
        command = self.sender.cli_command[0] + ' --broker-url 10.0.0.1:5672/queue --count 5 --msg-content test-msg'
    ...
    def test_link_durable_message_command_build(self):
        ...
        command = self.sender.cli_command[
                      0] + ' --broker-url 10.0.0.1:5672/queue --count 5 --link-durable --msg-content test-msg'
    ...
    def test_msg_property_build(self):
        ...
        command = self.sender.cli_command[
                      0] + ' --broker-url 10.0.0.1:5672/queue --count 5 --msg-property \"key1~val1\" ' \
                           '--msg-property \"key2=val2\" --msg-property \"key3=val3\"  --msg-content test-msg'
    ...
    def test_msg_content_list_build(self):
        ...
        command = self.sender.cli_command[
                      0] + ' --broker-url 10.0.0.1:5672/queue --count 5 --msg-content-list-item \"~10\" ' \
                           '--msg-content-list-item \"~5\"  --msg-content test-msg'
    ...
    def test_msg_content_map_build(self):
        ...
        command = self.sender.cli_command[
                      0] + ' --broker-url 10.0.0.1:5672/queue --count 5 ' \
                           '--msg-content-map-item \"key1~val1\" --msg-content-map-item \"key2=val2\" ' \

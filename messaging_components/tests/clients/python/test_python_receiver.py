"""
    Package for testing python external client receiver.
"""

import unittest
import mock
from messaging_components.clients.external.python import Receiver
...
class PythonExternalSender(unittest.TestCase):
    ...
    def test_command_prefix(self):
        ...
        :rtype:
        """
        prefix = 'cli-proton-python-receiver'
    ...
    def test_minimal_message_command_build(self):
        ...
        command = self.sender.cli_command[0] + ' --broker-url 10.0.0.1:5672/queue --count 5'
    ...
    def test_link_durable_message_command_build(self):
        ...
        command = self.sender.cli_command[
                      0] + ' --broker-url 10.0.0.1:5672/queue --count 5 --link-durable'
